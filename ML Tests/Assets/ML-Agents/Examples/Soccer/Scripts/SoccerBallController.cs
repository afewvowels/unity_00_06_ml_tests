...
public class SoccerBallController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if (sbrBody.velocity.magnitude < 1.0f)
        {
        ...
        else if (sbrBody.velocity.magnitude >= 1.0f)
        {
